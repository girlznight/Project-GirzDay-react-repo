...
export default function Post() {
  ...
  function handleShareYes() {
    ...
    navigator.clipboard.writeText(window.location.href)
      ...
      .catch(() => window.alert("클립보드 복사에 실패했습니다."));
  }
  ...
  return (
    <div className="relative min-h-screen bg-[#fcfcf8] p-4">
      <button onClick={handleLogout} className="fixed top-6 right-8 z-50 text-sm text-blue-600">
        Logout
      </button>
      ...
      <div className="relative w-full h-[90vh] overflow-hidden">
        <DndContext onDragEnd={handleDragEnd}>
          ...
          {images.map((img, i) => (
            ...
            >
              <img src={img.src} alt="" className="object-contain w-full h-full" draggable={false} />
            </div>
          ))}
        </DndContext>
      </div>
